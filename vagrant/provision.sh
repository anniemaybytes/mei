...
apt-get -qq -y -o Dpkg::Options::="--force-confnew" install php8.4 php8.4-xdebug php8.4-imagick php8.4-xml php8.4-fpm \
    php8.4-cli php8.4-gd php8.4-curl php8.4-mysql php8.4-bcmath php8.4-imagick php8.4-mbstring pv curl git unzip zip \
